  ...
  nav_panel(
    ...
    card_body(
      ...
      htmltools::browsable(
        ...
        tags$body(
          slideshow_right_slide(enterprise, slide_id = "enterprise_media", interval = 20000),
          # Add some custom CSS for the animations
          card_animation_slide()
          ))))
    ),
  ...
  nav_panel(
    ...
    card_body(
      ...
      htmltools::browsable(
        ...
        tags$body(
          slideshow_right_slide(websites, slide_id = "websites_media", interval = 20000),
          # Add some custom CSS for the animations
          card_animation_slide()
          )))
      )),
  ...
  nav_panel(
    ...
    card_body(
      ...
      htmltools::browsable(
        ...
        tags$body(
          slideshow_right_slide(apis, slide_id = "api_media", interval = 20000),
          # Add some custom CSS for the animations
          card_animation_slide()
          ))))
    ),
  ...
  nav_panel(
    ...
    card_body(
      ...
      htmltools::browsable(
        ...
        tags$body(
          slideshow_right_slide(cloud, slide_id = "cloud_media", interval = 20000),
          # Add some custom CSS for the animations
          card_animation_slide()
          ))))
    )
