...
htmltools::browsable(
  tags$html(
    ...
    tags$body(
      slideshow_right_slide(landingpage_cards),
...
htmltools::browsable(
  tags$html(
    ...
    tags$body(
      slideshow_right_slide(mission_vision_card),
      # Add some custom CSS for the animations
      card_animation()
    )
  )
...
testimonials_styling_top <- function() {
  tags$style("
    .slide-in-top {
          animation: slide-in-top 0.5s cubic-bezier(0.250, 0.460, 0.450, 0.940) both;
    }
...
testimonials_styling_bottom <- function() {
  tags$style("
    .slide-in-bottom {
...
testimonials_cards = list(
  ...
  list(
    body1 = card_body(
      style = testimonials_styling_bottom(),
      # Add a div tag for the card text
      tags$a(
    ...
    body2 = card_body(
      style = testimonials_styling_top(),
      # Add a div tag for the card text
      htmltools::tags$div(
        "Feedback",
        class = "card-text",
