...
card_body(
  ...
  card(
    ...
    card_body(
      style = "align: center;",
      tags$button(tags$a(href = "/pages/krs_services.qmd#Websites", "Go to Interactive Websites")))),
  ...
  card(
    ...
    card_body(
      style = "align: center;",
      tags$button(tags$a(href = "/pages/krs_services.qmd#APIs", "Go to APIs")))
    ),
  ...
  card(
    ...
    card_body(
      style = "align: center;",
      tags$button(tags$a(href = "/pages/krs_services.qmd#Cloud", "Go to Cloud Solutions")))
    )
)
