...
layout_column_wrap(
  ...
  # services card 1
  card(
    style = "background-color:#e9945b; min-width: 240px;",
    ...
    card_body(
      ...
      htmltools::tags$div(
        ...
        class = "card-text",
        style = "text-align: center; margin-left: 0%; margin-right: 0%; padding: 50px;"),
      ...
      htmltools::tags$div(
        ...
        class = "card-text",
        style = "text-align: center; margin-left: 15%; margin-right: 15%; padding-bottom: 50px;")),
    
card_body(
  tags$button(tags$a(href = "/pages/krs_services.qmd#Enterprise", "Go to Enterprise")))
),
  ...
  card(
    ...
    card_body(tags$button(tags$a(href = "/pages/krs_services.qmd#Websites", "Go to Interactive Websites")))),
  ...
  card(
    ...
    card_body(tags$button(tags$a(href = "/pages/krs_services.qmd#APIs", "Go to APIs")))
    ),
  ...
  card(
    ...
    card_body(tags$button(tags$a(href = "/pages/krs_services.qmd#Cloud", "Go to Cloud Solutions")))
    )
)
