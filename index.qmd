...
format: 
  html: 
    page-layout: full
logo: pages/images/logo/Kwiz_Inverted_Color.jpg
---

```{r functions, echo=FALSE, message=FALSE, warning=FALSE}
source("./pages/functions/sliding_cards.R")
source("./pages/functions/landingpage_plotly.R")
source("./pages/functions/solutions_media_cards.R")
```
...
tags$style("
  ...
  h1 {
    text-align: center; font-size: 24px; color: #e9945b; 
  }
  ...
  .card-header {
    ...
    font-size: 24px;
    font-weight: bold;
    border-bottom: 2px solid #00faf0;
    color: #e9945b; 
  }
...
layout_column_wrap(
  ...
  card_body(
      style = "background-image:url('/pages/images/logo/Kwiz_Main_Logo.jpg');",
      class = "card-body",
...
navset_card_tab(
  ...
  # services card 1
  nav_panel(
    style = "background-color:#f4ebe4;",

    title =  # Add a div tag for the card text
      htmltools::tags$div(
        "Enterprise Applications",
        style = "color: #e9945b; background-color: #00faf0; border-radius: 10px;"),
