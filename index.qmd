...
```{r mission_vision_data, echo=FALSE, message=FALSE, warning=FALSE}
...
landingpage_cards = list(
  ...
  list(
    body1 = card_body(
      ...
      # Add a div tag for the card text
      htmltools::tags$div(
        "Showcase your data analysis, create interactive dashboards, and explore complex concepts with your audience dirctly on your website. Quarto websites can include interactive components such as Observable JS, Shiny and HTML Widgets for stunning and engaging websites. ",
        class = "card-text",
        style = "text-align: center;")),
    ...
    tags$div(
      ...
      lapply(seq_along(testimonials_cards), function(i) {
        tags$div(
          ...
          scroll_arrows("slideshow-testimonials_slide")
  ),
      # Add some custom CSS for the animations
      card_animation_slide()
    )
