...
<style> 
@keyframes drawK {
  0% { transform: translate(-75px, 240px); } /* Bottom Left */
  8% { transform: translate(-75px, 0); } /* Top Left */
  16% { transform: translate(75px, 0); } /* Top Right */
  24% { transform: translate(-75px, 160px); } /* Middle left */
  32% { transform: translate(75px, 240px); } /* Bottom Right */
  40% { transform: translate(-75px, 160px); } /* Middle left */
  48% { transform: translate(75px, 0); } /* Top Right */
  56% { transform: translate(-75px, 0); } /* Top Left */
  64% { transform: translate(-75px, 240px); } /* Bottom Left */
  100% { transform: translate(-75px, 240px); } /* Bottom Left */
}
...
card_header(
  style = "text-align: center; padding-top: 0%; padding-left: 25%; padding-right: 25%; border-bottom: 0px; height: 360px;",
