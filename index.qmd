...
<style> 
@keyframes drawK {
  0% { transform: translate(-150px, 300px); } /* Bottom Left */
  8% { transform: translate(-150px, 0); } /* Top Left */
  16% { transform: translate(150px, 0); } /* Top Right */
  24% { transform: translate(-150px, 200px); } /* Middle left */
  32% { transform: translate(150px, 300px); } /* Bottom Right */
  40% { transform: translate(-150px, 200px); } /* Middle left */
  48% { transform: translate(150px, 0); } /* Top Right */
  56% { transform: translate(-150px, 0); } /* Top Left */
  64% { transform: translate(-150px, 300px); } /* Bottom Left */
  100% { transform: translate(-150px, 300px); } /* Bottom Left */
}
