  ...
  htmltools::tags$p(),
      ...
      htmltools::tags$div(
        ...
        htmltools::tags$image(
          ...
          class = "card-image",
          style = "border-radius: 10px; padding: 25%;",
          )),
...
card_body(
  style = "align: center;",
  tags$button(tags$a(href = "", tags$div(id = "bounce-text", "Go to Enterprise"))))
),
  ...
  card(
    ...
    card_body(
      style = "align: center;",
      tags$button(tags$a(href = "", tags$div(id = "bounce-text", "Go to Interactive Websites"))))),
  ...
  card(
    ...
    card_body(
      style = "align: center;",
      tags$button(tags$a(href = "", tags$div(id = "bounce-text", "Go to APIs"))))
    ),
  ...
  card(
    ...
    card_body(
      style = "align: center;",
      tags$button(tags$a(href = "", tags$div(id = "bounce-text", "Go to Cloud Solutions"))))
    )
)
...
layout_column_wrap(
  ...
  card_body(
    ...
    card_body(
      style = "align: center; background-color: #e9945b",
      tags$button(tags$a(href = "", tags$div(id = "bounce-text", "Submit"))))
  ),
